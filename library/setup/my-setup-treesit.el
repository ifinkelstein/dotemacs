;;; my-setup-treesit.el --- personal setup  -*- lexical-binding: t -*-
...
;;; Code:
(message "Setting up tree sitter...")

;; Taken from
;; https://github.com/Ethanlinyf/General-Pure-Emacs/blob/main/lisp/init-p-treesit.el
...
;;-------------------------------------------------------------------------------------------------
;;; end my-setup-treesit
(provide 'my-setup-treesit)
