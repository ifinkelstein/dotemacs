;;; navigation.el --- summary -*- lexical-binding: t -*-
...
(use-package goto-chg
  :vc (:fetcher github :repo emacs-evil/goto-chg)
...
(defun my-goto-projects ()
  "Open projects dir"
  (interactive)
  (find-file my-project-dir))
(defun my-goto-elisp-library ()
  "Open user elisp library."
  (interactive)
  (find-file my-user-elisp-dir))
...
;; Provide several commands to switch between various line positions, like moving to the beginning/end of code, line or comment.
(use-package mwim
...
;;;; Avy-like Navigation
;; use avy-style navigation for zapping parts of something
(use-package avy-zap
  :bind (("M-Z" . avy-zap-to-char-dwim)
         ("M-z" . avy-zap-up-to-char-dwim)))

;; patch avy-zap to use avy-goto-char-timer instead of a single char
...
(use-package easy-kill-extras
  :vc (:fetcher github :repo knu/easy-kill-extras.el)
  :config
...
;;;; dogears for automated bookmars
(use-package dogears
  :commands (beeminder-list-goals)
  :bind (("M-g d" . dogears-go)
         ("M-g r" . dogears-remember)
         ("M-g b" . dogears-back)
         ("M-g f" . dogears-forward)
         ("M-g l" . dogears-list)
         ("M-g s" . dogears-sidebar))
  :config
...
(use-package keyfreq
  :vc (:fetcher github :repo dacap/keyfreq)
  :config
