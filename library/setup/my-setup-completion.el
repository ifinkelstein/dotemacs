;;; my-completion.el --- summary -*- lexical-binding: t -*-
...
;; Savehist is set up in settings.el
...
(use-package embark
  ...
  (defun ijf-embark-google-search (term)
...
(use-package yasnippet
  ...
  (mkdir (concat my-all-snippets-dir "my-snippets/") t)
  (mkdir (concat my-all-snippets-dir "yasnippet-snippets/") t)
  :custom
  (yas-snippet-dirs `(;; custom snippets
                      ,(concat my-all-snippets-dir "my-snippets/")
                      ;; yas snippets
                      ,(concat my-all-snippets-dir "yasnippet-snippets/")))
...
(use-package yasnippet-snippets
  :after (yasnippet)
  :custom
  (yasnippet-snippets-dir (concat my-all-snippets-dir "yasnippet-snippets")))
