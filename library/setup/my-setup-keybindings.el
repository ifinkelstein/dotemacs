...
;; https://www.reddit.com/r/emacs/comments/1g445v9/meowmode_users_how_does_your_key_map_look_and/
...
(defun meow-setup ()
  ...
  (add-to-list 'meow-mode-state-list '(ready-player-mode . insert))
...
(bind-keys :prefix-map my+buffer-keys
           ...
           ("a" . bufler-list)
           ;; ("b" . consult-buffer)
           ("b" . bufler-switch-buffer) ;; switching to bufler for buffer management
