...
;;; org-remark for marking packages (formerly org-marginalia)
;; Known Limitations
...
;; source: https://nobiot.github.io/org-remark/#Usage-Features-Concepts

;; I am trying out org-remark to see how I like it for a bit.
(use-package org-remark
  ...
  (with-eval-after-load 'embark
    (define-key embark-general-map "H" #'org-remark-mark) )
  )
