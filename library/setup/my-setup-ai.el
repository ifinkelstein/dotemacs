...
system's default application."
    ...
    (message (concat "Sending query using " gptel-model))
    (gptel-request
        (concat "The text below is about scheduling a meeting. Summarize the following text in an RFC5545 compliant text response with the meeting date, time, and location. Do not add any additional characters to the top or last line of the response. Again, the rsponse should be able to be parsed by any RFC5545 compliant calendar software. If the meeting is via zoom, include a zoom link only when it was mentioned. Include a time zone. If no time zone is defined, assume central time (Chicago). If no year is defined, assume this year. The host or organizer should be Ilya Finkelstein with the email ilya@finkelsteinlab.org. In the notes field, include a concise synopsis of the topic of the meeting. Limit the synopsis to three sentences, maximum. Start the synopsis with [Generated by ChatGPT on "
