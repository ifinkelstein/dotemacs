;;; settings.el --- summary -*- lexical-binding: t -*-
...
;;; Code:
(message "Setting up core settings...")
...
(use-package files
  ...
  (run-with-idle-timer 5 t (lambda () (my-full-auto-save))))
...
(use-package desktop
  ...
  :config
  (setq desktop-dirname             (concat my-cache-dir "desktops")
...
(defun my-save-desktop-save-buffers-kill-emacs ()
...
(use-package time-stamp
  :ensure nil
  :commands (time-stamp my-time-stamp)
  :config
